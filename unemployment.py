...
# Select columns of men/women over the age of 20 to keep in the DataFrame
...
# Melt the DataFrame to convert from wide to long format to easily visualize data in Tableau
